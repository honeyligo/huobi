...
class Order:
    ...
    def json_parse(json_data, account_type):
        ...
        order.canceled_timestamp = convert_cst_in_millisecond_to_utc(json_data.get_int_or_default("canceled-at", 0))
        order.finished_timestamp = convert_cst_in_millisecond_to_utc(json_data.get_int_or_default("finished-at", 0))
