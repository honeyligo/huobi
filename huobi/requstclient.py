...
class RequestClient(object):
    ...
    def get_position(self, symbol="btc"):
        account_balance_list = self.get_account_balance()
    ...
    def get_profit(self, init_balance):
        price = self.get_market_trade("btcusdt")[0].price
        return self.get_position() + self.get_cash() / price - init_balance
