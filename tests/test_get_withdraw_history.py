...
class TestGetWithdrawHistory(unittest.TestCase):
    ...
    def test_result(self):
        ...
        self.assertEqual(convert_cst_in_millisecond_to_utc(1510912472199), withdraws[0].created_timestamp)
        self.assertEqual(convert_cst_in_millisecond_to_utc(1511145876575), withdraws[0].updated_timestamp)
